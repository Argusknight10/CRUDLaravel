        ...
        <form action="{{ route('beritas.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group mb-3">
                <label class="form-control w-full pt-6">
                    ...
                    <input type="text" placeholder="Tuliskan judul berita...."
            ...
            <div class="form-group mb-3">
                ...
                <textarea class="form-control @error('deskripsi') is-invalid @enderror textarea textarea-success w-full"
                    name="deskripsi" rows="5" placeholder="Tuliskan isi berita...">{{ old('deskripsi') }}</textarea>
            ...
            <a href="{{ route('beritas.index') }}" class="btn btn-md btn-circle btn-secondary"><i
