        ...
        <form action="{{ route('kategoris.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group mb-5">
                <label class="form-control w-full pt-6">
                    ...
                    <input type="text" placeholder="Tuliskan nama kategori...." class="@error('name') is-invalid @enderror input input-bordered input-success w-full form-control " name="name" value="{{ old('name') }}" />
                </label>
